      ...
      if (request == null) {
        ...
        if (request.length() == 0) {
          ...
          try{
            ...
            // Display on Wireshark and Web Browser
            builder.append("HTTP/1.1 422 Unprocessable Entity\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("The request was well-formed but was unable to be followed due to semantic errors");

            // Display on command line
            System.out.println("Error 422: Unprocessable Entity");
            System.out.println("The request was well-formed but was unable to be followed due to semantic errors");
          }
